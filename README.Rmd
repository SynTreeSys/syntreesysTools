...
For an overview of the main features of `syntreesysTools`, please read the 
[Get started](https://SynTreeSys.github.io/syntreesysTools/articles/syntreesysTools.html)
vignette.
...
- the [Get started](https://SynTreeSys.github.io/syntreesysTools/articles/syntreesysTools.html)
...
> Lima Renato (`r format(Sys.Date(), "%Y")`) syntreesysTools: An R 
...
check out our [Contributor Guidelines](https://github.com/SynTreeSys/syntreesysTools/blob/main/CONTRIBUTING.md).
